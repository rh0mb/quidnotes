...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { city: @university.city, country: @university.country, name: @university.name, students: @university.students }
    end
  ...
  test "should update university" do
    put :update, id: @university, university: { city: @university.city, country: @university.country, name: @university.name, students: @university.students }
    assert_redirected_to university_path(assigns(:university))
  end
